...
```
cd existing_repo
git remote add origin https://gitlab.com/vuduongkhang16/base-fe-reactts-vite.git
git branch -M main
...
- [Set up project integrations](https://gitlab.com/vuduongkhang16/base-fe-reactts-vite/-/settings/integrations)
